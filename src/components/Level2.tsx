...
export function Level2({ onComplete, onBack }: Level2Props) {
  ...
  const [currentPhrase] = useState(PHRASES[1]);
  ...
  if (showTutorial) {
    return <Tutorial type="copy-paste" level={2} onComplete={handleTutorialComplete} />;
  }
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-8">
      <div className="max-w-4xl w-full">
        <div className="flex items-center justify-between mb-8">
          ...
          <h1 className="text-blue-900">Level 2: Faster Copy & Paste</h1>
          <div className="w-32" />
        </div>
        ...
        {!gameOver ? (
          <div className="bg-white rounded-3xl p-12 shadow-xl border-4 border-blue-300">
            <p className="text-center mb-8 text-gray-700">
              You have 30 seconds! Copy and paste the text into all 5 boxes
            </p>
          ...
          >
            {success ? (
              <>
                ...
                <h2 className="mb-4 text-green-900">Amazing!</h2>
