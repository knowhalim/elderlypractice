...
const FILES = [
  { id: 1, name: 'Letter.txt', icon: FileText },
  { id: 2, name: 'Photo.jpg', icon: FileText },
  { id: 3, name: 'Recipe.doc', icon: FileText },
  { id: 4, name: 'Notes.txt', icon: FileText },
  { id: 5, name: 'Budget.xls', icon: FileText },
  { id: 6, name: 'Song.mp3', icon: FileText },
  { id: 7, name: 'Video.mp4', icon: FileText },
  { id: 8, name: 'Address.txt', icon: FileText },
  { id: 9, name: 'List.doc', icon: FileText },
  { id: 10, name: 'Memo.txt', icon: FileText },
];
  ...
  return (
    ...
    >
      <div className="text-center mb-6">
        ...
        <h3 className="text-blue-900 mb-2">My Documents Folder</h3>
        <p className="text-gray-600">
          Drag files here ({fileCount}/10)
        </p>
      </div>
      {fileCount > 0 && (
...
function Level4Content({ onComplete, onBack }: Level4Props) {
  ...
  if (showTutorial) {
    return <Tutorial type="drag-drop" level={4} onComplete={handleTutorialComplete} />;
  }
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-8">
      <div className="max-w-6xl w-full">
        <div className="flex items-center justify-between mb-8">
          ...
          <h1 className="text-blue-900">Level 4: Drag & Drop Files</h1>
          <div className="w-32" />
        </div>
        ...
        {!gameOver ? (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div>
              <h3 className="mb-4 text-gray-700">Files to Move:</h3>
          ...
          >
            {success ? (
              <>
                ...
                <h2 className="mb-4 text-green-900">Fantastic!</h2>
                <p className="mb-8 text-green-700">
                  You've mastered drag and drop!
                </p>
              ...
              <>
                ...
                <p className="mb-8 text-red-700">
                  You moved {droppedFiles.size}/10 files. Try again!
                </p>
                <div className="flex gap-4 justify-center">
...
export function Level4(props: Level4Props) {
  return (
